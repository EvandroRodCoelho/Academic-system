...
class TelaEditarAula:
    def __init__(self, aula, professores, disciplina):
        ...
        self.layout = [
            ...
            [sg.Combo(self.professor_nomes, key='professor', readonly=True, size=(30, 1), default_value=self.aula['professor'], font=("Helvetica", 14))],
            [sg.Text('Disciplina:', font=("Helvetica", 16))],
            [sg.Combo(self.disciplina_nome, key='disciplina', readonly=True, size=(30, 1), default_value=self.aula['disciplina'], font=("Helvetica", 14))],
            [sg.Text('Horário:', font=("Helvetica", 16))],
            [sg.Input(key='horario', size=(10, 1), default_text=self.aula['horario'], font=("Helvetica", 14))],
